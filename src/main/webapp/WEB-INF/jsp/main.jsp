...
<div class="container">
  ...
  <div class="modules">
    ...
    <a href="${pageContext.request.contextPath}/user/main/changePassword" class="module-link">
      修改密码
      <div class="module-description">更改你的登录密码</div>
    </a>

    <!-- 第二排模块 -->
    <a href="${pageContext.request.contextPath}/user/login" class="module-link">
      安全退出
  ...
  <!-- 安全退出按钮 -->
<%--  <a href="${pageContext.request.contextPath}/user/login" class="logout-btn">返回首页</a>--%>
</div>
</body>
</html>
